      ...
      <Card className="overflow-hidden p-0">
        <CardContent className="grid p-0 md:grid-cols-2">
          <form className="p-6 md:p-8">
            <FieldGroup>
              ...
              <FieldDescription className="text-center">
                ...
                <Link to="/sign-up" className="text-primary underline-offset-2 hover:underline font-medium">
                  Sign up
                </Link>
              </FieldDescription>
            </FieldGroup>
          ...
          <div className="relative hidden md:block">
            <div className="absolute inset-0 bg-sidebar flex flex-col items-center justify-center gap-4 p-8">
              <div className="flex size-12 items-center justify-center rounded-2xl bg-sidebar-primary text-sidebar-primary-foreground font-bold text-xl">
                Y
              </div>
